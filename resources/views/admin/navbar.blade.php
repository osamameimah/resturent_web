...
@endphp
                      @if (Auth::user()->image)
                                   <img class="img-xs rounded-circle" src="{{ asset('storage') }}/{{ Auth::user()->image }}" alt="image" />
                              @else
              ...
              <ul class="navbar-nav w-100" >
                  <li class="nav-item w-100" >
                      <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                          <input type="search" style="color: wheat;" class="form-control" placeholder="Search products" name="search">
                      </form>
                  </li>
              </ul>
              <ul class="navbar-nav navbar-nav-right" style="margin-right: 100px">
                  ...
                  <li class="nav-item dropdown border-left">
                      ...
                      <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                          ...
                          <a class="dropdown-item preview-item">
                              <div class="preview-thumbnail">
                                  <img src="{{ asset('admin/images/faces/arabic.png') }}" alt="image"
                              ...
                              <div class="preview-item-content">
                                  <p class="preview-subject ellipsis mb-1">العربية </p>
                                   ...
                                   <a class="dropdown-item preview-item">
                              <div class="preview-thumbnail">
                                  <img src="{{ asset('admin/images/faces/englisah.png') }}" alt="image"
                                      class="rounded-circle profile-pic">
                              </div>
                              <div class="preview-item-content">
                      ...
                      <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                          <div class="navbar-profile">
                              @if (Auth::user()->image)
                                   <img class="img-xs rounded-circle" src="{{ asset('storage') }}/{{ Auth::user()->image }}" alt="image" />
                              @else
                                  <img src="{{ asset('default.jpg') }}" alt="image" width="40px" />
                              @endif
...
@endphp --}}
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item preview-item" href="{{ route('profilee.show', Auth::user()->id) }}">
                              <div class="preview-thumbnail">
                                  <div class="preview-icon bg-dark rounded-circle">
                          ...
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item preview-item" href="{{ route('showpassword', Auth::user()->id) }}">
                              <div class="preview-thumbnail">
                                  <div class="preview-icon bg-dark rounded-circle">
