                ...
                <div class="col-lg-8">
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                            ...
                            @foreach ($data4 as $imagee)
                                {{-- <tr><td>{{$image->id}}</td> --}}

                                <?php foreach (json_decode($imagee->sliders)as $picturee) { ?>
                                <div class="item">
                                    <div class="img-fill">
                                        <img src="{{ asset('storage') }}/{{ $picturee }}" />
                                    </div>
                                </div>
                                <?php } ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <div class="row">
                            {{-- @foreach ($data4->photo as $image)
                                <div class="col-4">
                                    <img src="{{ asset('storage/imagee') }}/{{ $image->photo }}" alt="">
                                </div>
                            @endforeach --}}
                            @foreach ($data4 as $image)
                                {{-- <tr><td>{{$image->id}}</td> --}}
                                <td> <?php foreach (json_decode($image->photo)as $picture) { ?>
                                    <img src="{{ asset('storage') }}/{{ $picture }}"
                                        style="height:120px; width:200px; margin-top:15px;margin-right:10px;" />
                                    <?php } ?>
                                </td>
                                </tr>
                            @endforeach
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            ...
                            @foreach ($data22 as $frame)
                                <iframe width="600" height="500" src="{{ $frame->video }}">
                                    <i class="fa fa-play"></i></iframe>
                            @endforeach
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        ...
                        <p>Gaza - Palestine - AlRasead st . </p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    <i class="fa fa-phone"></i>
                                    <h4>Phone Numbers</h4>
                                    @foreach ($data22 as $data2)
                                        <span><a
                                                href="#">{{ $data2->phone_number1 }}<br>{{ $data2->phone_number2 }}</a><br></span>
                                    @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    @foreach ($data22 as $data2)
                                        <span><a
                                                href="#">{{ $data2->email1 }}<br>{{ $data2->email2 }}</a><br></span>
                                    @endforeach
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Klassy Cafe Co . 2022

                            <br>Design: Osama Meimah
                        </p>
                    </div>
                </div>
            </div>
